...
const NavMobile: React.FC<NavMobileProps> = ({
  ...
  const _renderMenuChild = (
    ...
    return (
      <ul className="nav-mobile-sub-menu relative ps-6 pb-1 text-base">
        <div className="absolute top-2 bottom-2 start-4 border-s-2 border-neutral-100 dark:border-neutral-700" />
  ...
  const renderSearchForm = () => {
    return (
      ...
      >
        <div className="relative bg-neutral-50 dark:bg-neutral-800 flex rounded-xl h-full">
          <input
            type="search"
            name="mbsearch"
            id="mbsearch"
            placeholder="Type and press enter"
            className="flex-1 border-none bg-transparent focus:outline-none focus:ring-0 w-full text-sm py-3.5 pe-10"
          />

          <button
            type="submit"
            className="pe-4 ps-2 py-2 absolute end-0 inset-y-0"
          >
